...
> 多智能体健康助理，基于 LangChain 1.x + LangGraph + A2A 协议
>
> **当前状态**：✅ v2.0 生产就绪，**16 阶段 / 17 tag 全部完成**
...
| 协议 | PHA 私有协议 | PHA + a2a-sdk 0.3.x 双协议 |
